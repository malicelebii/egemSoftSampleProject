...
class Products extends Component {
  ...
  render() {
    ...
    let products = this.props.filteredCategory ? this.props.products.filter(product=>product.category==this.props.filteredCategory):this.props.products;
    ...
    <Card style={{ width: "22rem", marginLeft: "30px", marginTop: "10px" }}>
         <a onClick={this.handleShow} style={{cursor:'pointer'}}>  <Card.Img style={{ height:'300px'}} variant="top" src={product.img} /> </a>
        <Card.Body >
    ...
    <p>Sondan başlayarak eski fiyatlar:  {[...product.price_history].reverse().slice(0,3).map((oldPrice,index)=><b>{oldPrice} TL,</b>  )}</p>
        </Card.Body>
        <Card.Footer>
          <ModalConfirmDelete
